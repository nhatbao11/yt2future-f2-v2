      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-12 justify-between relative">
        ...
        {steps.map((step, i) => (
          <div key={i} className="relative group flex flex-row lg:flex-col items-start lg:items-center gap-6 lg:gap-10 flex-1">
            ...
            <span className="hidden lg:block absolute -top-20 left-1/2 -translate-x-1/2 text-[140px] font-black text-slate-900/[0.05] group-hover:text-orange-500/[0.1] group-hover:-translate-y-6 transition-all duration-700 -z-10 select-none tracking-tighter not-italic">
              0{i + 1}
            </span>

            {/* 2. KHỐI ICON: NỔI KHỐI 3D KHI HOVER */}
            <div className="relative z-10 shrink-0">
              <div className="w-14 h-14 lg:w-24 lg:h-24 bg-[#001a41] text-orange-500 flex items-center justify-center 
                            shadow-[4px_4px_0px_0px_rgba(249,115,22,1)] 
                            lg:group-hover:-translate-y-6 lg:group-hover:-translate-x-2 
                            lg:group-hover:shadow-[20px_20px_0px_0px_rgba(249,115,22,1)] 
            ...
            <div className="relative z-10 lg:text-center space-y-4 pt-2 lg:pt-0">
              <div className="flex items-center lg:justify-center gap-2">
                <span className="text-orange-500 text-xl lg:text-lg tracking-[0.3em] font-black">0{i + 1}.</span>
                <h3 className="text-xl lg:text-3xl font-black text-[#001a41] uppercase tracking-tighter italic leading-none">
                  {step.title}
                </h3>
              </div>

              <div className="h-1 w-12 bg-orange-500 lg:mx-auto hidden lg:block opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
