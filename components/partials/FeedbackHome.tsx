    ...
    <section className="py-12 md:py-16 bg-gray-50 relative overflow-hidden">
      <div className="max-w-360 mx-auto px-4 md:px-12">
        ...
        <div className="mb-10 md:mb-16 border-l-4 md:border-l-8 border-[#001a41] pl-4 md:pl-6 text-left">
          <h2 className="font-black text-[#001a41] text-2xl md:text-5xl uppercase tracking-tighter leading-tight">
            Cảm nhận <span className="text-yellow-500">khách hàng</span>
          </h2>
                  ...
                  <div className="bg-white p-5 md:p-8 border-2 border-slate-900 shadow-[4px_4px_0px_0px_rgba(0,26,65,1)] md:shadow-[6px_6px_0px_0px_rgba(0,26,65,1)] h-[320px] md:h-[400px] flex flex-col justify-between transition-all rounded-none relative group hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
                    <div className="text-left">
                      <div className="flex gap-0.5 mb-3 md:mb-4">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} size={10} fill={i < fb.rating ? "#eab308" : "none"} className={i < fb.rating ? "text-yellow-500" : "text-slate-300"} />
                        ))}
                      </div>
                      ...
                      <div className="relative">
                        ...
                        {fb.content.length > 100 && (
                          <button
                            ...
                            className="mt-2 flex items-center gap-1 text-[8px] md:text-[9px] font-black text-yellow-500 uppercase tracking-widest md:group-hover:hidden"
                          >
                    ...
                    <div className="flex items-center gap-3 md:gap-4 border-t-2 pt-4 md:pt-6 border-slate-100 bg-white text-left">
                      ...
                      <div className="overflow-hidden">
                        ...
                        <p className="text-[7px] md:text-[8px] text-yellow-600 font-black uppercase tracking-widest mt-0.5">
                          Hội viên chiến lược
                        </p>
                      </div>
                    </div>
        ...
        <div className="mt-8 md:mt-12 flex justify-center">
          <button
            ...
            className="w-full md:w-fit inline-flex items-center cursor-pointer justify-center gap-3 bg-[#001a41] text-white px-8 md:px-12 py-4 md:py-6 rounded-none font-black text-[10px] md:text-[11px] uppercase tracking-[0.2em] transition-all shadow-[6px_6px_0px_0px_rgba(234,179,8,1)] active:translate-y-1 active:shadow-none border-2 border-slate-900"
          >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-black/40 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white w-full max-w-[400px] border-4 border-slate-900 shadow-[8px_8px_0px_0px_rgba(234,179,8,1)] rounded-none overflow-hidden animate-in zoom-in duration-200">
            <div className="p-4 border-b-4 border-slate-900 flex justify-between items-center bg-yellow-500">
            ...
            <form onSubmit={handleSubmit} className="p-5 md:p-8 space-y-5">
              <div className="flex justify-center gap-3">
                {[1, 2, 3, 4, 5].map((num) => (
                  <button key={num} type="button" onClick={() => setRating(num)} className="hover:scale-110 transition-transform">
                    <Star size={28} fill={num <= rating ? "#eab308" : "none"} className={num <= rating ? "text-yellow-500" : "text-slate-300"} />
                  </button>
                ))}
              </div>
              <div className="relative">
                <textarea
                  ...
                  className="w-full h-32 p-4 border-2 border-slate-900 text-slate-900 font-bold text-xs md:text-sm outline-none focus:bg-yellow-50 rounded-none resize-none leading-relaxed"
                  required
                />
              ...
              <button type="submit" disabled={loading} className="w-full bg-[#001a41] text-white py-4 font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-yellow-600 border-2 border-slate-900 transition-colors">
